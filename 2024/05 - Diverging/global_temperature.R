...
subtitle_text <- "<span style='font-size:40pt; color:red'>**2023 WAS THE HOTTEST YEAR**</span> with an average 1.17 °C increase in global land and surface temperature."
